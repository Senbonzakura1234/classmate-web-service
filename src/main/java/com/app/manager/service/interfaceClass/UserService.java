...
public interface UserService {
    ...
    Optional<UserProfileResponse> userProfile(String query, String currentUsername);
    Optional<UserProfileResponse> getUserProfile(String userId, String currentUsername);
